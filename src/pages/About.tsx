    ...
    return (
        <AboutDiv>
            ...
            <Typography.Text className="body-about">
                ...
                Siga nosso dia a dia, lançamentos e inspirações também pelo 
                <Typography.Link style={{ fontSize: "16px", fontWeight: "bold" }} onClick={handleClick}> Instagram </Typography.Link>e venha nos visitar.<br /><br />
            </Typography.Text>
